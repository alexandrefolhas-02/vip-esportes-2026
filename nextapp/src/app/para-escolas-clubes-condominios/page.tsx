...
export const metadata: Metadata = {
  ...
  description: "Leve a metodologia VIP Esportes para sua escola, clube ou condomínio. Projetos esportivos personalizados com gestão profissional no Rio de Janeiro.",
  keywords: ["esporte escola rio de janeiro", "projeto esportivo escola", "vôlei escola", "beach tennis condomínio", "aulas vôlei escola privada"],
};
...
const tiposParcerias = [
  { icon: GraduationCap, titulo: "Escolas", descricao: "Aulas de vôlei e beach tennis como atividade extracurricular ou dentro da grade escolar. Formação esportiva completa para seus alunos." },
  { icon: Building, titulo: "Clubes", descricao: "Programas esportivos para sócios com turmas organizadas por idade e nível. Gestão completa das atividades esportivas." },
  { icon: Home, titulo: "Condomínios", descricao: "Aulas de beach tennis e vôlei de praia nas quadras do condomínio. Conveniência e qualidade para os moradores." },
];
    ...
    <div className="pt-20 lg:pt-24">
      <section className="py-16 lg:py-24 bg-[#000040] relative overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <p className="mt-4 text-lg text-white/80 max-w-2xl leading-relaxed">
            Desenvolvemos projetos esportivos personalizados para instituições que desejam oferecer aulas de qualidade.
          </p>
      ...
      <section className="py-16 lg:py-20 bg-[#000040]">
        <div className="container text-center">
          <h2 className="font-heading text-2xl lg:text-3xl font-bold text-white uppercase mb-4">Vamos conversar sobre seu projeto?</h2>
          <p className="text-white/70 mb-8">Entre em contato e saiba como podemos ajudar sua instituição.</p>
          <a href={getWhatsAppUrl("escolasClubes")} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-turquesa hover:bg-turquesa-dark text-white font-semibold px-8 py-4 rounded-lg transition-all duration-200 active:scale-[0.97] text-lg">
            Quero levar a VIP para minha estrutura
          </a>
        </div>
      </section>
