        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-5 text-lg text-muted-foreground leading-relaxed">
              A metodologia VIP une ensino técnico, diversão, disciplina, socialização e desenvolvimento humano. Cada aula é pensada para respeitar o nível do aluno e incentivar a evolução constante.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {pilares.map((pilar) => (
              <div key={pilar.titulo} className="bg-white border border-gray-100 rounded-xl p-5 hover:shadow-md hover:border-turquesa/30 transition-all duration-300">
