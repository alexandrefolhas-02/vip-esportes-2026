          ...
          <div className="order-1 lg:order-2 py-16 lg:py-20 flex flex-col justify-center lg:pl-10 xl:pl-16">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-white text-2xl font-heading font-bold uppercase tracking-tight leading-tight">Paula Pequeno</p>
              </div>
            </div>
            ...
            <p className="text-white/70 text-base lg:text-lg leading-relaxed max-w-lg mb-8">
              As modalidades de Vôlei e Vôlei de Praia da VIP Esportes têm a metodologia e a assinatura de Paula Pequeno — uma das maiores atletas da história do voleibol brasileiro.
            </p>

            <div className="flex flex-col sm:flex-row gap-3">
              <a href={getWhatsAppUrl("escolaVoleiPaulaPequeno")} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-turquesa hover:bg-turquesa-dark text-white font-semibold px-6 py-3 rounded-lg transition-all duration-200 active:scale-[0.97] text-sm">
                Quero saber mais
              </a>
              <Link href="/escola-de-volei-paula-pequeno" className="inline-flex items-center justify-center gap-2 border border-white/30 hover:border-turquesa text-white hover:text-turquesa font-semibold px-6 py-3 rounded-lg transition-all duration-200 text-sm">
