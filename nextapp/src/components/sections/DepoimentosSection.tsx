    ...
    <section className="py-20 lg:py-28 bg-white">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {depoimentos.map((dep) => (
            <div key={dep.id} className="bg-gray-50 border border-gray-100 rounded-xl p-6 hover:shadow-md transition-all duration-300">
              <Quote className="w-8 h-8 text-turquesa/30 mb-3" />
              <p className="text-foreground leading-relaxed italic">&ldquo;{dep.texto}&rdquo;</p>
