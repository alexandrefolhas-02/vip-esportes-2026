  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={HERO_IMAGE}
          alt="Beach Tennis na praia do Rio de Janeiro"
      ...
      <div className="container relative z-10 pt-24 pb-16 lg:pt-32 lg:pb-24">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-10 animate-fade-in-up" style={{ animationDelay: "0.6s" }}>
            ...
            <Link
              href="/unidades"
              className="inline-flex items-center justify-center gap-2 border-2 border-white/30 hover:border-turquesa text-white hover:text-turquesa font-semibold px-8 py-4 rounded-lg transition-all duration-200"
            >
              Conhecer unidades
            </Link>
          </div>
