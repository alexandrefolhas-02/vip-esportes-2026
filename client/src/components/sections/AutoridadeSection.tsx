      ...
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <p className="mt-5 text-lg text-muted-foreground leading-relaxed">
            A VIP Esportes usa o esporte como ferramenta de desenvolvimento técnico, físico, social e emocional. Nossas aulas são planejadas para que cada aluno evolua no seu ritmo, com acompanhamento profissional e um ambiente positivo.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {cards.map((card, i) => (
            <div
              key={card.titulo}
              className="group relative bg-white border border-gray-100 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
